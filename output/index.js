...
var vnode$1 = h('div#container.two.classes', {
  on: {
    click: someFn
  }
}, [h('span', {
...
}, 'This is now italic type'), ' and this is still just normal text', h('a', {
  props: {
    href: '/bar'
  }
